...
所有演示账号的统一密码均为：`12345678`。

各端账号范围如下，登录页默认预填每个范围内的第一个账号：

| 端 | 手机号范围 | 数量 | 预填账号 | 账号身份 |
| --- | --- | ---: | --- | --- |
| 用户端 | `13700000001` ～ `13700000005` | 5 | `13700000001` | 小林、陈晨、爱丽丝、大卫、埃里克 |
| 商家端 | `13800000001` ～ `13800000005` | 5 | `13800000001` | 声选音频、家电、运动、腕表、美妆商家 |
| 平台端 | `13900000001` | 1 | `13900000001` | 平台管理员 |
