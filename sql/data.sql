...
-- 清理旧版演示脚本曾生成的额外用户，保证用户端账号固定为 5 个。
DELETE FROM users
WHERE id IN (
...
VALUES
    ('00000000-0000-4000-8000-000000000001', 'admin@example.com', crypt('12345678', gen_salt('bf')), '平台管理员', '13900000001', 'platform', 'active'),
    ('00000000-0000-4000-8000-000000000002', 'audio@example.com', crypt('12345678', gen_salt('bf')), '声选音频商家', '13800000001', 'merchant', 'active'),
    ('00000000-0000-4000-8000-000000000003', 'daily@example.com', crypt('12345678', gen_salt('bf')), '声选家电商家', '13800000002', 'merchant', 'active'),
    ('00000000-0000-4000-8000-000000000004', 'sports@example.com', crypt('12345678', gen_salt('bf')), '声选运动商家', '13800000003', 'merchant', 'active'),
    ('00000000-0000-4000-8000-000000000005', 'watch@example.com', crypt('12345678', gen_salt('bf')), '声选腕表商家', '13800000004', 'merchant', 'active'),
    ('00000000-0000-4000-8000-000000000006', 'beauty@example.com', crypt('12345678', gen_salt('bf')), '声选美妆商家', '13800000005', 'merchant', 'active'),
    ('00000000-0000-4000-8000-000000000101', 'lin@example.com', crypt('12345678', gen_salt('bf')), '小林', '13700000001', 'customer', 'active'),
    ('00000000-0000-4000-8000-000000000102', 'chen@example.com', crypt('12345678', gen_salt('bf')), '陈晨', '13700000002', 'customer', 'active'),
    ('00000000-0000-4000-8000-000000000103', 'alice@example.com', crypt('12345678', gen_salt('bf')), '爱丽丝', '13700000003', 'customer', 'active'),
    ('00000000-0000-4000-8000-000000000104', 'david@example.com', crypt('12345678', gen_salt('bf')), '大卫', '13700000004', 'customer', 'active'),
    ('00000000-0000-4000-8000-000000000105', 'eric@example.com', crypt('12345678', gen_salt('bf')), '埃里克', '13700000005', 'customer', 'active')
...
VALUES
    ('10000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000002', '声选 · 通勤音频', 'sound-digital', '本地演示集合店，展示通勤音频的真实品牌型号。', NULL, '13800000001', true, NULL),
    ('10000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000002', '声选 · 旗舰耳机', 'cloud-listening', '本地演示集合店，不代表任何品牌官方授权。', NULL, '13800000001', true, NULL),
    ('10000000-0000-4000-8000-000000000003', '00000000-0000-4000-8000-000000000002', '声选 · 运动耳机', 'commute-audio', '本地演示集合店，收录运动与真无线耳机型号。', NULL, '13800000001', true, NULL),
    ('10000000-0000-4000-8000-000000000004', '00000000-0000-4000-8000-000000000002', '声选 · 有线音频', 'blue-tone-audio', '本地演示集合店，收录监听与有线音频型号。', NULL, '13800000001', true, NULL),
    ('10000000-0000-4000-8000-000000000005', '00000000-0000-4000-8000-000000000003', '声选 · 家用咖啡', 'daily-coffee', '本地演示集合店，展示真实品牌咖啡机型号。', NULL, '13800000002', true, NULL),
    ('10000000-0000-4000-8000-000000000006', '00000000-0000-4000-8000-000000000003', '声选 · 胶囊咖啡', 'morning-coffee', '本地演示集合店，按咖啡机类型展示商品。', NULL, '13800000002', true, NULL),
    ('10000000-0000-4000-8000-000000000007', '00000000-0000-4000-8000-000000000003', '声选 · 恒温水具', 'boiling-kettle', '本地演示集合店，收录可筛选容量和温控的水壶。', NULL, '13800000002', true, NULL),
    ('10000000-0000-4000-8000-000000000008', '00000000-0000-4000-8000-000000000003', '声选 · 日用热饮', 'temperature-home', '本地演示集合店，展示日常热饮小家电。', NULL, '13800000002', true, NULL),
    ('10000000-0000-4000-8000-000000000009', '00000000-0000-4000-8000-000000000004', '声选 · 公路跑鞋', 'flyover-running', '本地演示集合店，展示公路训练跑鞋型号。', NULL, '13800000003', true, NULL),
    ('10000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000004', '声选 · 稳定支撑', 'city-running', '本地演示集合店，展示支撑和缓震跑鞋型号。', NULL, '13800000003', true, NULL),
    ('10000000-0000-4000-8000-000000000011', '00000000-0000-4000-8000-000000000004', '声选 · 越野跑鞋', 'trail-running', '本地演示集合店，展示越野跑鞋型号。', NULL, '13800000003', true, NULL),
    ('10000000-0000-4000-8000-000000000012', '00000000-0000-4000-8000-000000000004', '声选 · 竞速训练', 'rhythm-sports', '本地演示集合店，展示竞速与训练跑鞋型号。', NULL, '13800000003', true, NULL),
    ('10000000-0000-4000-8000-000000000013', '00000000-0000-4000-8000-000000000005', '声选 · 机械腕表', 'timeless-watches', '本地演示集合店，展示真实自动机械表型号。', NULL, '13800000004', true, NULL),
    ('10000000-0000-4000-8000-000000000014', '00000000-0000-4000-8000-000000000005', '声选 · 经典腕表', 'lume-watches', '本地演示集合店，展示石英与经典腕表型号。', NULL, '13800000004', true, NULL),
    ('10000000-0000-4000-8000-000000000015', '00000000-0000-4000-8000-000000000005', '声选 · 运动腕表', 'polar-watches', '本地演示集合店，展示耐用和防水腕表型号。', NULL, '13800000004', true, NULL),
    ('10000000-0000-4000-8000-000000000016', '00000000-0000-4000-8000-000000000005', '声选 · 光动能腕表', 'dial-workshop', '本地演示集合店，展示 Eco-Drive 腕表型号。', NULL, '13800000004', true, NULL),
    ('10000000-0000-4000-8000-000000000017', '00000000-0000-4000-8000-000000000006', '声选 · 经典唇妆', 'bloom-beauty', '本地演示集合店，展示真实品牌与色号。', NULL, '13800000005', true, NULL),
    ('10000000-0000-4000-8000-000000000018', '00000000-0000-4000-8000-000000000006', '声选 · 雾面唇妆', 'lip-lab', '本地演示集合店，按色调和雾面妆效筛选。', NULL, '13800000005', true, NULL),
    ('10000000-0000-4000-8000-000000000019', '00000000-0000-4000-8000-000000000006', '声选 · 轻润唇妆', 'rose-makeup', '本地演示集合店，展示润泽与缎光唇妆。', NULL, '13800000005', true, NULL),
    ('10000000-0000-4000-8000-000000000020', '00000000-0000-4000-8000-000000000006', '声选 · 持妆唇妆', 'light-makeup', '本地演示集合店，展示长效唇妆色号。', NULL, '13800000005', true, NULL);
